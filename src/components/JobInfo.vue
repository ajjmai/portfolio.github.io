        ...
        <div class="columns">
          <div class="column">
            ...
            <p class="pb-2">
              ...
              legal background I would be very interested in working in projects
          ...
          <div class="column">
            ...
            <p class="pb-2">
              <span class="has-text-weight-bold"
                >Career Development Opportunities</span
              >
            ...
            <p class="pb-2">
              ...
              important to help and support others. Supportive working
              environment allows talent to grow.
            </p>
            <p class="pb-2">
              <span class="has-text-weight-bold">Creativity</span> - I have a
              passion for creative problem solving. I'd love to be able to
              contribute to the projects with my own ideas.
            </p>
            <p class="pb-2">
              <span class="has-text-weight-bold">Diversity</span> - I enjoy
